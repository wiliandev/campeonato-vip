          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card bg-primary text-white o-hidden h-100">
              <div class="card-body">
                ...
                <h4><b id="total_users"></b> Total de usuários</h4>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card bg-danger text-white o-hidden h-100">
              <div class="card-body">
                ...
                <h4><b id="total_inactive_users"></b> Usuários Inativos</h4>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card bg-success text-white o-hidden h-100">
              <div class="card-body">
                ...
                <h4><b id="total_active_users"></b> Usuários ativos</h4>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card bg-info text-white o-hidden h-100">
              <div class="card-body">
                ...
                <h4><b id="total_admins"></b> Administradores</h4>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-8">
        <div class="card mb-3">
          <div class="card-header">
            ...
            Usuários criados mensalmente</div>
          <div class="card-body">
      ...
      function createdUsersChart(){
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            // Defina uma nova família de fontes padrão e cor da fonte para imitar o estilo padrão do Bootstrap
            Chart.defaults.global.defaultFontFamily = '-apple-system,system-ui,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif';
            Chart.defaults.global.defaultFontColor = '#292b2c';

            // Usuários criados em gráfico de linha
      ...
      function genderDistributionChart (){
        $.ajax({
          ...
          success:function(data){
            ...
            // Gráfico de pizza de distribuição de gênero
