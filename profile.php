<?php include('include/header.php'); ?>
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs mt-5" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active font-weight-bold" id="profile-tab" data-toggle="tab" name="profile" href="#profile" role="tab" aria-controls="home" aria-selected="true">Perfil</a>
            </li>
            <li class="nav-item">
                <a class="nav-link font-weight-bold" id="profile-tab" data-toggle="tab" href="#edit-profile" role="tab" aria-controls="profile" aria-selected="false">Editar Perfil</a>
            </li>
            <li class="nav-item">
                <a class="nav-link font-weight-bold" id="messages-tab" data-toggle="tab" href="#edit-password" role="tab" aria-controls="messages" aria-selected="false">Editar senha</a>
            </li>
        </ul class="mb-5">
        <!-- Tab panes -->
                            ...
                            <form id="user_form">
								...
								<div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="link" name="link" maxlength="500"
                                        placeholder="Digite o link da conta" readonly>
                                ...
                                <button class="btn btn-primary btn-block" type="submit">Atualizar perfil</button>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <form id="update_password_form">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="current_password" name="current_password" placeholder="Digite a senha atual">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" id="confirm_password" name="confirm_password"
                                        maxlength="50" placeholder="Confirme a nova senha">
...
<script>
  ...
  $(document).ready(function(){
	...
	function check_link() {
        if ($.trim($('#link').val()) == '') {
            $("#link_error_message").html("Link da conta é obrigatório.");
    ...
    function check_current_password() {
        ...
        if( $.trim( $('#current_password').val() ) == '' ){
            $("#current_password_error_message").html("A senha atual é um campo obrigatório.");
            $("#current_password_error_message").show();
            $("#current_password").addClass("is-invalid");
            error_current_password = true;
        }else if(current_password_length < 8) {
            $("#current_password_error_message").html("Pelo menos 8 caracteres.");
            $("#current_password_error_message").show();
            $("#current_password").addClass("is-invalid");
            error_current_password = true;
        } else {
    ...
    function check_new_password() {
        ...
        if( $.trim( $('#new_password').val() ) == '' ){
            $("#new_password_error_message").html("A nova senha é um campo obrigatório.");
            $("#new_password_error_message").show();
            $("#new_password").addClass("is-invalid");
            error_new_password = true;
        }else if(new_password_length < 8) {
            $("#new_password_error_message").html("Pelo menos 8 caracteres.");
            $("#new_password_error_message").show();
            $("#new_password").addClass("is-invalid");
            error_new_password = true;
        }else if(new_password == current_password) {
            $("#new_password_error_message").html("A nova senha não pode ser igual à senha atual.");
            $("#new_password_error_message").show();
            $("#new_password").addClass("is-invalid");
    ...
    function updateUser() {
        ...
        if (error_fullname == false && error_username == false && error_email == false  && error_link == false && error_gender == false) {
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.status) {
                        ...
                        $("#current_password_error_message").html("As senhas não coincidem.");
                        $("#current_password_error_message").show();
                    }else{
